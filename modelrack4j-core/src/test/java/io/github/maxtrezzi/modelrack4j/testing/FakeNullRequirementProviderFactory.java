...
/** Breaks the SPI contract by reporting no requirement for either key. */
public final class FakeNullRequirementProviderFactory extends FakeProviderFactory {

    public FakeNullRequirementProviderFactory() {
        super(null, null);
    }

    @Override
    public String providerId() {
        return "fake-null-requirement";
    }
