...
/** Stands in for a server the user runs, such as Ollama: takes no key and needs an address. */
public final class FakeKeylessProviderFactory extends FakeProviderFactory {

    public FakeKeylessProviderFactory() {
        super(KeyRequirement.FORBIDDEN, KeyRequirement.MANDATORY);
    }
