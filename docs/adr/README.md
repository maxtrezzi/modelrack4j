...
| [0055](0055-custom-properties-are-carried-as-text.md) | Carry a configuration block's custom properties as text | Accepted — its compatibility consequence amended by ADR-0059 |
